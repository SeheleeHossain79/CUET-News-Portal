    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          The CUET News Portal is designed to provide students, faculty, and
          staff with an easy-to-access platform that centralizes all important
          academic updates, announcements, events, and achievements happening at
...
const styles = StyleSheet.create({
  ...
  section: { padding: 20 },
  sectionTitle: { fontSize: 22, fontWeight: "bold", color: "#001f3f", marginBottom: 10 },
